...
public class LinkedQueue implements Queue {
	 ...
	 * 
	 * @return the size of this Queue. Performance: runs in O(1) time.
	 **/
	public int size() {
		return size;
	}
	 ...
	 * 
	 * @return true if this Queue is empty, false otherwise. Performance: runs
	 *         in O(1) time.
	 **/
	...
	/**
	 * 
	 * nth() returns the nth item in this LinkedQueue. Items in the queue are
	 * numbered from 1.
	 * 
	 * @param n
	...
	/**
	 * append() appends the contents of q onto the end of this LinkedQueue. On
	 * completion, q is empty.
	 * 
	 * @param q
	 *            the LinkedQueue whose contents should be appended onto this
	 *            LinkedQueue.
	 **/
