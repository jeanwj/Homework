...
public class DList {
	...
	public void insertFront(Object item) {
		// Your solution here.
		if(this.size == 0){
			this.head.prev = this.head.next = this.newNode(item, head, head);
		}else{
	...
	public void insertAfter(Object item, DListNode node) {
		...
		if(node == null) 
			return;
		DListNode newNode = this.newNode(item, node, node.next);
	...
	public void insertBefore(Object item, DListNode node) {
		...
		if(node == null) 
			return;
		DListNode newNode = this.newNode(item, node.prev, node);
